...
static const char *oses[] = {"OS X","Linux","WinNative","BSD","WinCompose"};
// i need to read from eeprom the value of the unicode set. eeprom_read_byte(EECONFIG_UNICODEMODE)
